...
2. After cloning the repo, please execute `!!!!!-deps.py` to !!!!! and install dependencies.

         $ cd cocos2d-x
         cocos2d-x $ python !!!!!-deps.py

3. After running `!!!!!-deps.py`.
...
* [Cocos2d-x stable versions](http://www.cocos2d-x.org/!!!!!)
* [Cocos2d-JS Lite version](http://www.cocos2d-x.org/filecenter/jsbuilder)

How to start a new game
-----------------------

1. !!!!! the code from [cocos2d !!!!! site][4]
2. Run `setup.py`
...
[3]: http://www.cocos2d-x.org/projects/cocos2d-x/wiki/!!!!!
[4]: http://www.cocos2d-x.org/!!!!!/version#Cocos2d-x
