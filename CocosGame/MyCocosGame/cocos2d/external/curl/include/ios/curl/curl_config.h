...
/**
 ...
 ./configure --disable-ftp --disable-dict --disable-imap --disable-gopher --disable-file --disable-manual --disable-libcurl-option \
 ...
 --without-librtmp --without-libssh2 --without-nss --disable-verbose \
 --disable-debug --disable-curldebug --enable-symbol-hiding \
 --disable-alt-svc --enable-static --disable-shared
 ...
 Host setup:       x86_64-apple-darwin17.3.0
 ...
 curl version:     7.65.1
 SSL:              no      (--with-{ssl,gnutls,nss,mbedtls,cyassl,schannel,secure-transport,mesalink,amissl} )
 SSH:              no      (--with-libssh2)
 zlib:             enabled
 ...
 Protocols:        HTTP
 Features:         IPv6 UnixSockets libz AsynchDNS
