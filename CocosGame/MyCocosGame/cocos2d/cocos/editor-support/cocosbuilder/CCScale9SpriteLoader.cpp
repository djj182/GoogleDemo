...
void Scale9SpriteLoader::parseProperties(cocos2d::Node * pNode, cocos2d::Node * pParent, CCBReader * ccbReader)
    {
        tempInsetRect_ = ((cocos2d::ui::Scale9Sprite *)pNode)->getCapInsets();
        NodeLoader::parseProperties(pNode, pParent, ccbReader);
        
        ((cocos2d::ui::Scale9Sprite *)pNode)->setCapInsetsForCocosBuilder(tempInsetRect_);
