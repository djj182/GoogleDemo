...
function buildjni() {
    # compile apk
    COCOS_CONSOLE="$1/cocos2d/cocos2d-console-3.12/bin"
    echo $COCOS_CONSOLE
    cd $2
...
#    fi
    ...
    find ./obj/ -name "libgame.so" -exec rm {} \;

    /opt/android-ndk-r10e/ndk-build NDK_DEBUG=0 -j 4 NDK_APPLICATION_MK=jni/Application_ndk_r10.mk
