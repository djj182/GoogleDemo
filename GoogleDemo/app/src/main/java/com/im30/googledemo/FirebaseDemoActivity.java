        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    mTrace.stop();
                    FirebaseDemoActivity.this.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(FirebaseDemoActivity.this, "Trace completed",
                ...
                .addOnCompleteListener(new OnCompleteListener<String>() {
                    ...
                    public void onComplete(@NonNull Task<String> task) {
                        if (!task.isSuccessful()) {
                            ...
                            Toast.makeText(
                                    FirebaseDemoActivity.this, "getString(R.string.text_read_error", Toast.LENGTH_LONG)
                                    .show();
                            return;
                        }
